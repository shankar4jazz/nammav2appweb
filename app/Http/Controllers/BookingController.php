...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $auth_user = authSession();
        if($auth_user->hasAnyRole(['handyman'])){

        return  redirect(route('booking.webassigned', ['id'=> $result->id, 'handyman_id[]' =>$auth_user->id]))->withSuccess($message);
			
        }


        return  redirect(route('booking.assign_form', ['id'=> $result->id]))->withSuccess($message);
    }
    ...
    public function  bookingAssignForm(Request $request)
    {
        ...
        return view('booking.assign_form', compact('bookingdata', 'pageTitle', 'auth_user'));
    }
