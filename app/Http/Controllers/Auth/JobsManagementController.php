...
use App\DataTables\JobsManageDataTable;
...
class JobsManagementController extends Controller
{
     ...
     */
    public function index(JobsManageDataTable $dataTable, Request $request)
    {
        ...
        $assets = ['datatable'];
        return $dataTable->render('jobsmanage.index', compact('pageTitle', 'assets', 'status'));
    }
