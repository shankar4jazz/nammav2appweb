...
class AccessPayment extends Model
{
    ...
    protected $fillable = [ 'employer_id', 'job_id','plan_id','count', 'datetime', 'discount', 'total_amount', 'payment_type', 'txn_id','payment_id', 'signature','order_id', 'payment_status', 'description', 'other_transaction_detail', 'is_verified' ];
