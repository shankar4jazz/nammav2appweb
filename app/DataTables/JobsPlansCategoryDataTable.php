...
class JobsPlansCategoryDataTable extends DataTable
{
    use DataTableTrait;
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($plan) {
                return view('jobsplancategory.action', compact('plan'))->render();
            })
            ->addIndexColumn()
            ->rawColumns(['action']);
    }
     ...
     */
    public function query(JobsPlanCategory $model)
    {
    ...
    protected function getColumns()
    {
        return [
            Column::make('DT_RowIndex')
                ...
                Column::make('ta_description'),
                Column::make('en_description'),
