...
$menu->add('<span>'.__('sms sent').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('sms sent').'</span></span>', ['route' => 'sms-send.index'])
->prepend('<svg width="14" height="14" class="sidebar-menu-icon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">  
    <path d="M2.5 0.75H11.5C12.3242 0.75 13 1.42578 13 2.25V11.25C13 12.0742 12.3242 12.75 11.5 12.75H2.5C1.67578 12.75 1 12.0742 1 11.25V2.25C1 1.42578 1.67578 0.75 2.5 0.75ZM2.5 1.5C2.22656 1.5 2 1.72656 2 2V11C2 11.2734 2.22656 11.5 2.5 11.5H11.5C11.7734 11.5 12 11.2734 12 11V2C12 1.72656 11.7734 1.5 11.5 1.5H2.5ZM3.1875 3.3125C3.1875 3.20703 3.28125 3.125 3.375 3.125H10.625C10.7188 3.125 10.8125 3.20703 10.8125 3.3125V3.9375C10.8125 4.04297 10.7188 4.125 10.625 4.125H3.375C3.28125 4.125 3.1875 4.04297 3.1875 3.9375V3.3125ZM3.1875 5.6875C3.1875 5.58203 3.28125 5.5 3.375 5.5H7.625C7.71875 5.5 7.8125 5.58203 7.8125 5.6875V6.3125C7.8125 6.41797 7.71875 6.5 7.625 6.5H3.375C3.28125 6.5 3.1875 6.41797 3.1875 6.3125V5.6875ZM3.1875 7.9375C3.1875 7.83203 3.28125 7.75 3.375 7.75H10.625C10.7188 7.75 10.8125 7.83203 10.8125 7.9375V8.5625C10.8125 8.66797 10.7188 8.75 10.625 8.75H3.375C3.28125 8.75 3.1875 8.66797 3.1875 8.5625V7.9375Z" fill="#6C757D"/>
</svg>
')
->link->attr(['class' => '']);
...
$menu->add('<span>'.__('jobseeker').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('jobseeker').'</span></span>', ['route' => 'jobseeker.index'])
->prepend('<svg width="16" height="12" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</div><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/partials/_body_sidebar.blade.php ENDPATH**/ ?>