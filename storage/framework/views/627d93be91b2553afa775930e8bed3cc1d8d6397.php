...
<?php $component->withAttributes([]); ?>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <?php echo e(Form::model($bookingdata,['method' => 'POST','route'=>'booking.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'booking'] )); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="customer_id" name="customer_id" value="<?php echo e($bookingdata->customer_id); ?>">
                            ...
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('serial_no',__('messages.serial_no').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('serial_no', null, ['class'=>"form-control" , 'rows'=>3 , 'placeholder'=> __('messages.serial_no') ])); ?>

                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('model',__('messages.model').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('model', null, ['class'=>"form-control" , 'rows'=>3 , 'placeholder'=> __('messages.model') ])); ?>
                            ...
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('issue',__('messages.issue').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('issue', null, ['class'=>"form-control" , 'rows'=>3  , 'placeholder'=> __('messages.issue') ])); ?>

                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('extra_items',__('messages.extra_items').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('extra_items', null, ['class'=>"form-control" , 'rows'=>3  , 'placeholder'=> __('messages.extra_items') ])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            ...
                                            <?php echo e(Form::label('estimate',__('messages.estimate').' <span class="text-danger"></span>',['class'=>'form-control-label'], false )); ?>

                                            <?php echo e(Form::number('estimate', null, ['min' => 0, 'step' => 'any' , 'id' =>'estimate','class'=>"form-control" , 'rows'=>3  , 'placeholder'=> __('messages.estimate') ])); ?>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $('#discount').val(0);
                $('#advance').val(0);
                var category_id = "<?php echo e(isset($bookingdata->contact_number) ? $bookingdata->contact_number : ''); ?>";
            ...
            function getCustomer(mobile_no) {
                ...
                var get_subcategory_list = "<?php echo e(route('ajax-list', [ 'type' => 'setuser','mobile_no' =>''])); ?>" + mobile_no;
                get_subcategory_list = get_subcategory_list.replace('amp;', '');
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        //console.log(datas);
                        if (datas.length == 0) {
                            window.location.href = "<?php echo e(route('quickbooking')); ?>";
...
<?php endif; ?><?php /**PATH C:\wamp64\www\nammav2appweb\resources\views/booking/fastcreate.blade.php ENDPATH**/ ?>