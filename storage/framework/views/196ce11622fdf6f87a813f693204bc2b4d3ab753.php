...
?>
<?php echo e(Form::open(['route' => ['jobs-plans-category.destroy', $plan->id], 'method' => 'delete','data--submit'=>'plan'.$plan->id])); ?>

<div class="d-flex justify-content-end align-items-center">
    <?php if(auth()->user()->hasAnyRole(['admin'])): ?>
    <a class="mr-2" href="<?php echo e(route('jobs-plans-category.create',['id' => $plan->id])); ?>" title="<?php echo e(__('messages.update_form_title',['form' => __('messages.plan') ])); ?>"><i class="fas fa-pen text-primary"></i></a>
...
<?php echo e(Form::close()); ?><?php /**PATH C:\wamp64\www\nammav2appweb\resources\views/jobsplancategory/action.blade.php ENDPATH**/ ?>