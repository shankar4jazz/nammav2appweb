            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="hidden" id="trial_period" name="trial_period" value="<?php echo e($plans->trial_period ?? ''); ?>">
                        <div class="row">
...
<?php endif; ?><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/jobspayment/create.blade.php ENDPATH**/ ?>