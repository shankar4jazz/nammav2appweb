...
<?php echo e(Form::hidden('type', $tabpage, array('placeholder' => 'id','class' => 'form-control'))); ?>
 ...
 <div class="row">
    <div class="form-group col-md-12" >
        <label for="enable_stripe"><?php echo e(__('messages.payment_on',['gateway'=>__('messages.stripe')])); ?></label>
        <div class="custom-control custom-switch">
            <input type="checkbox" class="custom-control-input" name="status" id="enable_stripe" <?php echo e(!empty($payment_data) && $payment_data->status == 1 ? 'checked' : ''); ?>>
 ...
 <div class="row" id='enable_stripe_payment'>
    <div class="form-group col-md-12">
        <label class="form-control-label"><?php echo e(__('messages.payment_option',['gateway'=>__('messages.stripe')])); ?></label><br/>
    ...
    <div class="form-group col-md-12">
        <?php echo e(Form::label('stripe_url',trans('messages.stripe_url').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

        <?php echo e(Form::text('stripe_url',old('stripe_url'),['id'=>'stripe_url','placeholder' => trans('messages.stripe_url'),'class' =>'form-control','required'])); ?>

        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        <?php echo e(Form::label('stripe_key',trans('messages.stripe_key').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

        <?php echo e(Form::text('stripe_key',old('stripe_key'),['id'=>'stripe_key','placeholder' => trans('messages.stripe_key'),'class' =>'form-control','required'])); ?>

        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        <?php echo e(Form::label('stripe_publickey',trans('messages.stripe_publickey').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

        <?php echo e(Form::text('stripe_publickey',old('stripe_publickey'),['id'=>'stripe_publickey','placeholder' => trans('messages.stripe_publickey'),'class' =>'form-control','required'])); ?>
...
</script><?php /**PATH C:\wamp64\www\nammav2appweb\resources\views/paymentgateway/stripe.blade.php ENDPATH**/ ?>