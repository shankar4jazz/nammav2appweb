                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('title',trans('messages.name').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('title',old('title'),['placeholder' => trans('messages.name'),'class' =>'form-control','required'])); ?>
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <?php echo e(Form::text('youtube_url',old('youtube_url'),['placeholder' => trans('messages.url'),'class' =>'form-control','required'])); ?>
...
<?php endif; ?><?php /**PATH /var/www/vhosts/jobs7.in/newsapp.jobs7.in/resources/views/news/create.blade.php ENDPATH**/ ?>