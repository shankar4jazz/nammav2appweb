    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="d-flex align-items-center">
                <div class="ml-auto">
                    <a class="btn btn-info" title="Add Quick Boooking" href="<?php echo e(route('quickbooking')); ?>"><i class="fas fa-newspaper" aria-hidden="true"></i>Quick Booking </a>
                </div>
                <div class="ml-2">
                    <a class="btn btn-success" title="Add Quick Jobs" href="<?php echo e(route('jobs.quick')); ?>"><i class="fa fa-plus" aria-hidden="true"></i> Quick Jobs </a>
                </div>
                <div class="ml-2">
                    <a class="btn btn-primary" title="Add News" href="<?php echo e(route('news.create')); ?>"><i class="fa fa-plus" aria-hidden="true"></i> Add News </a>
                </div>
            </div>
...
</div><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/partials/_body_header.blade.php ENDPATH**/ ?>