<?php echo e(Form::model($settings,['method' => 'POST','route'=>'sendPvtJobsPushNotification', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'push_notification'] )); ?>
...
<script>
    ...
    function getJobs(district, state = "") {
        ...
        var state_route = "<?php echo e(route('ajax-list', [ 'type' => 'push_pvt_jobs','district_id' =>''])); ?>" + district;
    ...
    //             });
    //         }
</script><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/pushnotification/privatejobs-push-notification.blade.php ENDPATH**/ ?>