                    ...
                    <div class="card-body p-30">
                        <div class="provider-details-overview mb-30">
                            ...
                            <div class="provider-details-overview__statistics">
                                ...
                                <div class="statistics-card statistics-card__style2 statistics-card__already-withdraw">                                
                                    <a href="<?php echo e(route('job_invoice_pdf',$providerdata->id)); ?>" class="btn btn--primary text-capitalize btn--lg mw-75"><?php echo e(__('Invoice')); ?></a>'
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="media-body">
                                        ...
                                        <ul class="contact-list">
                                            ...
                                            <i class="fa-solid fa-address-book"></i>
                                                <span class="contact-info-text"><?php echo e($earningData['other_transaction_detail']); ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/jobs/view.blade.php ENDPATH**/ ?>