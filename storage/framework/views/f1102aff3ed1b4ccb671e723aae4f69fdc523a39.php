    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::model($plan,['method' => 'POST','route'=>'plans.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'plan'] )); ?>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\nammav2appweb\resources\views/plan/create.blade.php ENDPATH**/ ?>