...
<div class="border-bottom pb-3">
    <div class="row pb-1 gy-2">
        <div class="col-6 col-lg-3">
            <div>
                <h4 class="c1 mb-2 pb-1"><?php echo e(__('messages.book_placed')); ?></h4>
                <p class="opacity-75"><?php echo e($bookingdata->date); ?></p>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div>
                <h4 class="c1  mb-2 pb-1"><?php echo e(__('messages.booking_status')); ?></h4>
                <p class="opacity-75"><?php echo e($bookingdata->status); ?></p>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div>
                <h4 class="c1  mb-2 pb-1"><?php echo e(__('messages.payment_status')); ?></h4>
                <p class="opacity-75"><?php echo e(optional($bookingdata->payment)->payment_status ?? '-'); ?></p>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div>
                <h4 class="c1  mb-2 pb-1"><?php echo e(__('messages.booking_amount')); ?></h4>
                <p class="opacity-75"><?php echo e(!empty($bookingdata->total_amount) ? getPriceFormat($bookingdata->total_amount + $extraValue ): 0); ?></p>
            </div>
        </div>
    </div>
</div>
<div class="row justify-content-between mt-5">
    ...
    <div class="col-md-6 col-xl-4 mb-5 mb-md-0">
        <?php if(count($bookingdata->bookingActivity) > 0): ?>
        <div class="col-md-5 col-lg-12">
            <div class="card">
                <div class="card-body activity-height">
                    <ul class="iq-timeline">
                        <?php date_default_timezone_set($admin->time_zone ?? 'UTC'); ?>
                        <?php $__currentLoopData = $bookingdata->bookingActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <div class="timeline-dots"></div>
                            <h6 class="float-left mb-1"><?php echo e(str_replace("_"," ",ucfirst($activity->activity_type))); ?></h6>
                            <small class="float-right mt-1"><?php echo e($activity->datetime); ?></small>
                            <div class="d-inline-block w-100">
                                <p><?php echo e($activity->activity_message); ?></p>
                            </div>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
...
</div><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/booking/status.blade.php ENDPATH**/ ?>