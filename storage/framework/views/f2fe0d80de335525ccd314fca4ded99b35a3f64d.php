        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a  href="<?php echo e(route('handyman.index')); ?>">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.handyman')])); ?></p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                            ...
                            <ul class="common-list p-0">
                                ...
                                ?>
                                    <li class="d-flex flex-wrap gap-2 align-items-center justify-content-between"  style="pointer-events:none;">
                                        ...
                                        <span class="badge rounded-pill py-2 px-3 badge-primary text-capitalize"><?php echo e($booking->status); ?></span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
</script><?php /**PATH C:\wamp64\www\nammav2appweb\resources\views/dashboard/provider-dashboard.blade.php ENDPATH**/ ?>