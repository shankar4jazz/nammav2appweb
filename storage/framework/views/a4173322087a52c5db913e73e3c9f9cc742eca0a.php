    ...
    <div class="container-fluid">
        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.booking')])); ?></p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.service')])); ?></p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.provider')])); ?></p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                            ...
                            <div class="card total-booking-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_jobs']) ? $data['dashboard']['count_total_jobs']: 0); ?> </h4>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('Jobs')])); ?></p>
                                        </div>
                                        <div class="col-auto d-flex align-items-center flex-column">
                                            <div class="iq-card-icon iq-card-icon-booking icon-shape  rounded-circle shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card total-booking-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold"><?php echo e(!empty($data['dashboard']['today_total_jobs']) ? $data['dashboard']['today_total_jobs']: 0); ?> </h4>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('Today Jobs')); ?></p>
                                        </div>
                                        <div class="col-auto d-flex align-items-center flex-column">
                                            <div class="iq-card-icon iq-card-icon-booking icon-shape  rounded-circle shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card total-booking-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold"><?php echo e(!empty($data['dashboard']['yesterday_total_jobs']) ? $data['dashboard']['yesterday_total_jobs']: 0); ?> </h4>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('Yesterday Jobs')); ?></p>
                                        </div>
                                        <div class="col-auto d-flex align-items-center flex-column">
                                            <div class="iq-card-icon iq-card-icon-booking icon-shape  rounded-circle shadow">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold" style="font-size: 18px;"><?php echo e(getPriceFormat(round($data['jobs_total_revenue']))); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text"><?php echo e(__('messages.total_name', ['name' => __('messages.revenue')])); ?></p>
                                        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card top-providers">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4 class="font-weight-bold"><?php echo e(__('messages.top_provider')); ?></h4>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card top-providers">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4 class="font-weight-bold"><?php echo e(__('messages.top_customer')); ?></h4>
...
</script><?php /**PATH C:\wamp64\www\nammav2appweb-3\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>