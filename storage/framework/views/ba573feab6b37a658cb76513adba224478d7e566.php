                            ...
                            <div class="table-responsive">
                                <table class="table data-table mb-0">
                                    <thead class="table-color-heading">
                                        ...
                                        <th scope="col"><?php echo e(__('messages.admin_earning')); ?></th>
                                        <th scope="col"><?php echo e(__('messages.provider_earning')); ?></th>
...
var table = $('.data-table').DataTable({
    processing: true,
    serverSide: true,
    ajax: "<?php echo e(route('earningData')); ?>",
    columns: [
...
<?php endif; ?><?php /**PATH /var/www/vhosts/jobs7.in/newsapp.jobs7.in/resources/views/earning/index.blade.php ENDPATH**/ ?>