    ...
    <script type="text/javascript">
        (function($) {
            ...
            function checkExistCustomer(mobile_no) {
                ...
                var get_subcategory_list = "<?php echo e(route('ajax-list', [ 'type' => 'existing_customer','mobile_no' =>''])); ?>" + mobile_no;
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (data.status_code == 404) {
                            window.location.href = "<?php echo e(route('user.quickcreate', ['mobile_no' =>''])); ?>" + mobile_no;
                        }
                        if (data.status_code == 200) {

                            window.location.href = "<?php echo e(route('booking.addquick', ['mobile_no' =>''])); ?>" + mobile_no;
                        }
                    }
                });
            }
...
<?php endif; ?><?php /**PATH /var/www/vhosts/jobs7.in/newsapp.jobs7.in/resources/views/booking/fast.blade.php ENDPATH**/ ?>