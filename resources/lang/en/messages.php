<?php return array(
        ...
        'update' => 'Update',
        'profile' => 'Profile',
        'permission_denied' => "Don't have permission for this action.",
        ...
        'sub_amount'=>" Sub Total Amount",
        'amount'=>"Total Amount",
        'quantity'=>"Quantity",
        'other_charge'=>"Service Amount",
        'enter_customer_mobile_no'=>"Enter mobile number",
        'process'=>'Process',

        'quick_form_title' => "Quick Booking",
        ...
        'news' => "News",
        'news_lists' => "News Lists",
        'news_categories' => "News Categories",
        'news_category' => "News Category",
        'news_category_list' => "News Category",
        'add_news' => "News",
        'news_list' => "News",
        'rejected' => "Rejected",
        'reason'=>"Reason",
        ...
        'jobs' => "Jobs",
        'jobs_lists' => "Jobs Lists",
        'jobs_categories' => "Jobs Categories",
        'title' => "Title",
        'slug' => "Url Slug",
        'job_role'=> "Job name / job role",
        ...
        "your_work" => "Work details" ,
        "salary" => "Salary",
        "brothers" => "How many brothers do you have?",
        "sisters" => "How many sisters do you have?",
        "eating_habbits" => " Eating Habbits",
        "smoke_habbits" => "Smoking Habbits",
        "drink_habbits" => "Drinking Habbits",
        "family_status" => "Family Status",
        "family_type" => "Family Type",
        "family_value" => "Family Value",
        "is_disability" => "Is Disability",
        "disability_details" => "Details",
        "is_anycaste" => 'Marriage at any caste and subcaste',
        "photo_urls" => "Photo",
        "own_property" => "Own Properties",
        "star_id" => "Star",
        "gothram" => "Gothram",
        "is_dhosam" => "Is Dhosam",
        "about_dhosam" => "About Dhosam",
        "horoscope_urls" => "Horoscope image",
        ...
        "marital_n" => "Never Married",
        "marital_w" => "Widow/Widower",
        "marital_d" => "Devorced",
        "marital_a" => "Awaiting Divorced",
        "height" => "Height",
        "gender" => "Gender",

        "for_who"=> "Matrimony Profile For",
        'my_self' => "My Self",
        'my_son' => "My Son",
