...
<div class="card-body p-0">
    ...
    <div class="pay-box">
        <div class="pay-method-details">
            ...
            <p><span>{{__('messages.amount')}} : </span><strong>{{!empty($bookingdata->total_amount) ? getPriceFormat($bookingdata->total_amount + $extraValue ): 0}}</strong></p>
        </div>
        <div class="pay-booking-details">
            <div class="row mb-2">
                <div class="col-sm-6"><span>{{__('messages.booking_status')}} :</span></div>
                <div class="col-sm-6 align-text"><span class="c1" id="booking_status__span">{{ $bookingdata->status ?? '-'}}</span></div>
            </div>
            <div class="row mb-2">
    ...
    <h3 class="mb-3">{{__('messages.booking_summery')}}</h3>
                    ...
                    <tbody>
                        ...
                        <tr class="grand-total">
                            ...
                            <td class="bk-value">
                                ...
                                @endphp
                                <h3>{{!empty($total_amount) ? getPriceFormat($total_amount) : 0}}</h3>
                            </td>
                        </tr>
                    </tbody>
                </table>
