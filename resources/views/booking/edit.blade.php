                        ...
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <div class="form-group col-md-6 font-weight-bold">
                                <div class="form-check form-check-inline">                                 
                                    ...
                                    <input class="form-check-input" type="radio" name="is_shop" id="inlineRadio1" value="1" {{ $bookingdata->is_shop == '1' ? 'checked' :
                        ''}}>
                                    <label class="form-check-label" for="inlineRadio1">Online Booking (by customer)</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_shop" id="inlineRadio2" value="2"  {{ $bookingdata->is_shop == '2'? 'checked' :
                        ''}}>
