    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('jobs-categories.index') }}" class="float-right btn btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> {{ __('messages.back') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($categorydata,['method' => 'POST','route'=>'jobs-categories.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'category'] ) }}
                        {{ Form::hidden('id') }}
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label" for="jobs_category_image">{{ __('messages.image') }} </label>
                            ...
                            @if(getMediaFileExit($categorydata, 'jobs_category_image'))
                            <div class="col-md-2 mb-2">
                                @php
                                $extention = imageExtention(getSingleMedia($categorydata, 'jobs_category_image'));
                                @endphp
                                <img id="jobs_category_image_preview" src="{{getSingleMedia($categorydata,'jobs_category_image')}}" alt="#" class="attachment-image mt-1" style="background-color:{{ $extention == 'svg' ? $categorydata->color : '' }}">
