                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ Form::select('category_id', [optional($subcategory->category)->id => optional($subcategory->category)->name], optional($subcategory->category)->id, [
                                            ...
                                            'data-ajax--url' => route('ajax-list', ['type' => 'category'],true, 'https'),
                                        ]) }}
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <a class="text-danger remove-file" href="{{ route('remove.file', ['id' => $subcategory->id, 'type' => 'subcategory_image']) }}" data--submit="confirm_form" data--confirmation='true' data--ajax="true" title='{{ __("messages.remove_file_title" , ["name" =>  __("messages.image") ]) }}' data-title='{{ __("messages.remove_file_title" , ["name" =>  __("messages.image") ]) }}' data-message='{{ __("messages.remove_file_msg") }}'>
